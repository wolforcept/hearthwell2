...
public class JeiCatFlare extends JeiCat<RecipeFlare> {
	...
	public JeiCatFlare() {
		super(RecipeFlare.class, HearthWell.MODID, "Flare Recipes", "entity_flare", RecipeFlare.WIDTH, RecipeFlare.HEIGHT, HearthWell.flare_torch);
	}
