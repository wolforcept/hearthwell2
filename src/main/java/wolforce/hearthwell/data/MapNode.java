...
public class MapNode implements Serializable {
	...
	MapNode(byte x, byte y, String name, int time, String stack, String description, String fullDescription, String[] recipes_ids, String[] parent_ids, String[] required_items) {
		this.x = x;
		this.y = y;
		this.name = name;
		this.time = time;
